...
export default function Notes() {
    ...
    const noteData = { chatId, summaryId, summary, setSummary, userSession, note_id, title, flashcards, messages, setMessages, fetchNote}
    const chatData = { summary, userSession, messages, setMessages, note_id, handleSaveChat}
    const flashcardData = { flashcardId, summary, userSession, note_id, flashcards, setFlashcards, fetchNote };
            ...
            <ThemeProvider theme={theme}>
                ...
                <Grid2 container justifyContent={'center'}>
                    <Tabs value={value} onChange={handleChange}>
                        <Tab disabled={summary == ""} label="Chat with AI" icon={<AssistantIcon />} />
