...
export default function Admin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await axios.post('http://localhost/api/admin.php', params.toString());
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response2 = await axios.post("http://localhost/api/adminusers.php", params.toString(), {
        headers: {
